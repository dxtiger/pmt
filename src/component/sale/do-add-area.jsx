    ...
    return (
      ...
      <ul className="clearfix do-add-time">
        <li span="8" className="fleft" style={{width:'30%'}}>
          ...
          <Select size="large" placeholder="请选择区域" style={{width: 140}} name="areaId"  value={this.state.areaId} onChange={this.onChange.bind(this,'areaId')}>
                    <Option value="area-1">区域1</Option>
                    <Option value="area-2">区域2</Option>
                    <Option value="area-3">区域3</Option>
                    <Option value="area-4">区域4</Option>
                    <Option value="area-5">区域5</Option>
                  </Select>
        </li>
        <li span="8" className="fleft" style={{width:'30%'}}>
...
class SaleADDArea extends React.Component{
  ...
  updateTableData(index,opts){
    ...
    this.props.addPrizeTime('area',data); // 同步到父页面
  }
