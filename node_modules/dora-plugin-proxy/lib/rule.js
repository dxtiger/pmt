...
exports.default = function (args) {
  var cwd = args.cwd;
  var proxyConfig = args.proxyConfig;
  var log = args.log;
  ...
  return {
    ...
    shouldUseLocalResponse: function shouldUseLocalResponse(req) {
      return batchMatch(req, proxyConfig, function (val) {
    ...
    dealLocalResponse: function dealLocalResponse(req, reqBody, callback) {
      return batchMatch(req, proxyConfig, function (val, pattern) {
    ...
    */
    ...
    replaceRequestOption: function replaceRequestOption(req, option) {
      ...
      function setOption(val) {
        ...
        newOption.path = (0, _path.join)(path, reqObj.path);
        // Fix anyproxy
    ...
    */
    ...
    replaceResponseHeader: function replaceResponseHeader(req, res, header) {
      return (0, _objectAssign2.default)({}, header, {
